...
- Regenerable artifacts need no backup: `full-combined.txt` (the search text layer; regenerated by SessionStart's daily throttle + on demand at deep-path start)
